    ...
    IN LPARAM lParam OPTIONAL)
{
    ...
    /* 如果是WM_WinIniChange或 WM_DevModeChange, 同时lparam有效的情况 */
    if ((Msg == WM_WININICHANGE || Msg == WM_DEVMODECHANGE) && ARGUMENT_PRESENT(lParam)) 
    {
        try 
        {
...
#define CHARALIGN sizeof(WCHAR)
    ...
    try {
        ...
        RtlCopyMemoryF(&cmn, pcmn, sizeof(cmn));
