    ...
    BOOL fAnsi)
{
    ...
    /* 服务端必须处理线程间的SendMessages 给服务端的处理函数 */
    /*
...
#ifndef LATER
    /* 如果窗口有一个客户端worker proc, 同时尚未被subcalssed, 直接派发处理，否则正常处理 */
    /*
